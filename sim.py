...
#Manufacturers = [
    makemanufacturer("Mercedes", 8, 350, 7.7,9.1, "Abhyuday Jha", 0.3),
    makemanufacturer("Red Bull", 8, 370, 7.5, 9.2, "Jha Family", 0.7)
#]

#Monza = Track("Monza", 3.7, 10, 80, 1)


#f1drivers = [
    makedriver("Max Verstappen", 9.7, 9.3, 8.9, Manufacturers[1], 3),
    makedriver("Lewis Hamilton", 8.9, 8.3, 9.9, Manufacturers[0], 2.998),
    makedriver("Bottas", 7.1, 8.3, 5.3, Manufacturers[1], 3.2)

#sim = racing(f1drivers, Monza, 50)
